            ...
            <table class="table-fixed w-full  table table-striped table-bordered">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- <a href="{{route('menu.edit',$restoran->id)}}"><button class="bg-green-500 px-4 py-1 text-sm rounded text-white font-semibold border border-red-200 hover:text-white  hover:border-transparent focus:outline-none">
                                    Edit </button> -->

                            <form action="{{route('menu.destroy',$restoran->id)}}" method="POST" class="inline">
